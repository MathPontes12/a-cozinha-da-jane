...
const Sobre = () => {
    return(
        <div className="flex flex-col items-center xl:gap-20 gap-10">
            <Titles titulo="Sobre" />
            <h1 className=" text-white text-justify xl:text-[22px] text-[14px] xl:mx-[112px] mx-[10px] xl:indent-20 indent-6 xl:leading-12 leading-8">
            ...
            <img className="xl:mx-[132px] mx-[10px] w-fit xl:h-[250px] h-[100px]" 
